...
Settings displays the version and build number from the installed Flutter bundle. Version 1.0.5 (build 6) includes source balance. Software tests cover volume composition, source selection, initial RTP gain, persistence, and version display; they do not establish physical switching latency or loudness normalization.
